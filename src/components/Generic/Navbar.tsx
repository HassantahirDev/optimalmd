            ...
            {profilePicture ? (
              <img 
                ...
                onError={(e) => {
                  ...
                  (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80";
                }}
              />
            ) : (
              <img 
          ...
          <div className="absolute right-0 mt-2 w-56 bg-gray-800 border border-gray-600 rounded-lg shadow-xl z-50">
            ...
            <div className="py-2">
              <button
                ...
                className="w-full flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700 transition-colors duration-200"
              >
              ...
              <button
                ...
                className="w-full flex items-center px-4 py-2 text-red-400 hover:bg-gray-700 transition-colors duration-200"
              >
