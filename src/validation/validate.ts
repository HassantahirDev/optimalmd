...
export const adminPatientCreationSchema = Yup.object({
  ...
  ethnicityRace: Yup.string()
    .optional(),
  
  primaryCarePhysician: Yup.string()
    .optional(),
  
  insuranceProviderName: Yup.string()
    .optional(),
  ...
  insurancePhoneNumber: Yup.string()
    .optional(),
  
  guarantorResponsibleParty: Yup.string()
    .optional(),
